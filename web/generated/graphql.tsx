...
export type UserFragmentFragment = { __typename?: 'UserResponse', token?: string | null | undefined, user?: { __typename?: 'User', userId: string, username: string, email: string } | null | undefined, error?: { __typename?: 'ErrorResponse', field?: string | null | undefined, message: string } | null | undefined };
